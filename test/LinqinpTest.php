...
class LinqinpTest extends TestCase
{
     ...
     */
    public function last(array $set): void
    {
        list($case, $expected) = $set;
     ...
     * @param array $set
     * @return void
     * @dataProvider lastOrDefaultProvider
     */
    public function lastOrDefault(array $set): void
    {
        list($case, $expected) = $set;
     ...
     * @return array
     */
    public function lastOrDefaultProvider(): array
    {
        $seed00 = [];
        $func00 = function (int $x) {
            return $x > 1 && $x < 3;
     ...
     */
    public function countTest(array $set): void
    {
        list($case, $expected) = $set;
    ...
    public function countProvider(): array
    {
        ...
        $set07 = $this->createCase($seed07, $func07, $ex07);
     ...
     */
    public function anyTest(array $set): void
    {
        list($case, $expected) = $set;
     ...
     */
    public function allTest(array $set): void
    {
        list($case, $expected) = $set;
